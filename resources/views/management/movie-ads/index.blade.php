        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <a href="{{ route('management.movie-ads.create') }}"
                    ...
                    <div class="group relative bg-gray-50 dark:bg-gray-700/50 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all"
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 flex items-center justify-end space-x-2">
                                <a href="{{ route('management.movie-ads.edit', $ad) }}"
                                ...
                                <form action="{{ route('management.movie-ads.destroy', $ad) }}"
                                      method="POST"
                                      class="inline-block"
...
@push('scripts')
    ...
    <script>
		...
		function updateOrder() {
			...
			fetch('{{ route("management.movie-ads.update-order") }}', {
				method: 'POST',
				headers: {
		...
		function toggleAdStatus(id) {
			fetch(`/management/movie-ads/${id}/toggle-status`, {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
					'X-CSRF-TOKEN': '{{ csrf_token() }}'
