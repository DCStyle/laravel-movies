...
@section('content')
    <div class="max-w-7xl mx-auto px-4 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.ads.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                            ...
                            <div class="flex items-center p-4 group">
                                ...
                                <div class="flex flex-1 items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.ads.destroy', $ad) }}" method="POST" class="inline-block"
