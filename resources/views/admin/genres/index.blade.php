        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ number_format($genres->total()) }}</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Tổng số thể loại</p>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left hidden sm:table-cell">
                            <span class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Số phim</span>
                        </th>
                        ...
                        <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 hidden sm:table-cell">
                                <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                {{ $genre->movies_count > 0 ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-200' }}">
                                    {{ number_format($genre->movies_count) }} phim
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h3 class="mt-4 text-sm font-medium text-gray-900 dark:text-white">Chưa có thể loại nào</h3>
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Bắt đầu bằng cách tạo thể loại đầu tiên của bạn.</p>
                                    <a href="{{ route('admin.genres.create') }}"
